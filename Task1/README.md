...
| **4.Секретные**        | Ключи доступа к госреестрам (ЕГРН, Росреестром), ЦОД и cloud сервисы | Утечка (компрометация ключей → взлом систем)         | Критический  | Компрометация ключей → взлом систем      
|                        | Криптографические ключи (шифрование платежей)                        |Искажение(подмена данных(ключей)→фальсификация сделок)| Критический  | Подмена данных в госреестрах → фальсификация сделок 
